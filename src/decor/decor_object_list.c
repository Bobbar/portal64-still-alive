...
static struct DecorObjectDefinition sDecorObjectDefinitions[] = {
    ...
    [DECOR_TYPE_SCRAWLINGS006A] = {
        ...
        0.0f,
        1.5f,
        OVERLAYS_OVERLAY_SCRAWLINGS006A_DYNAMIC_MODEL,
        .materialIndex = OVERLAY_INDEX,
        .soundClipId = -1,
        .soundFizzleId = -1,
    },
    [DECOR_TYPE_SCRAWLINGS006B] = {
        {
            CollisionShapeTypeNone,
            NULL,
            0.0f,
        ...
        0.0f,
        1.5f,
        OVERLAYS_OVERLAY_SCRAWLINGS006B_DYNAMIC_MODEL,
        .materialIndex = OVERLAY_INDEX,
        .soundClipId = -1,
        .soundFizzleId = -1,
    },
    [DECOR_TYPE_SCRAWLINGS006C] = {
        {
            CollisionShapeTypeNone,
            NULL,
            0.0f,
        ...
        0.0f,
        1.5f,
        OVERLAYS_OVERLAY_SCRAWLINGS006C_DYNAMIC_MODEL,
        .materialIndex = OVERLAY_INDEX,
        .soundClipId = -1,
        .soundFizzleId = -1,
    },
